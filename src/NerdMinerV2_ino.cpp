...
void setup()
{
  ...
  TaskHandle_t minerTask1, minerTask2 = NULL;
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 3584, (void*)0, 3, &minerTask1, 0); // Pinned to Core 0
    //xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-0", 5000, (void*)0, 1, &minerTask1, 0);
    #else
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 4096, (void*)0, 3, &minerTask1, 0);
    #endif
  #else
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-0", 5000, (void*)0, 1, &minerTask1, 0); // Pinned to Core 0
    #else
  ...
  #if defined(CONFIG_IDF_TARGET_ESP32)
  xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-1", 5000, (void*)1, 1, &minerTask2, 0); // Pinned to Core 0
  #else
